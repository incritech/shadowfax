        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              path: "sync",
              action: async (...args) =>
                (await import("./routes/organization")).syncOrganizationsAction(
                  ...args
                ),
            },
            {
              ...
              loader: async (...args) =>
                (await import("./routes/organization")).singleOrgLoader(
                  ...args
                ),
              children: [
                {
                ...
                },
                {
                  ...
                  id: "/project",
                  loader: async (...args) =>
                    (await import("./routes/project")).projectLoader(...args),
                  children: [
                    {
                      path: ":projectId",
