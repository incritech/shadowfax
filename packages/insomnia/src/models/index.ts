...
export interface BaseModel {
  ...
  //   - Settings, and Project, which never have a parentId
...
export function all() {
  ...
  // For example, settings, project and workspace are global models, with project and workspace being the top-most parents,
